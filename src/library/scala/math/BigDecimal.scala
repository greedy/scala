...
object BigDecimal {
  ...
  lazy val MinLong = new BigDecimal(BigDec valueOf Long.MinValue, defaultMathContext)

  @deprecated("Use Long.MaxValue", "2.9.0")
  lazy val MaxLong = new BigDecimal(BigDec valueOf Long.MaxValue, defaultMathContext)
