...
object Properties extends PropertiesTrait {
   ...
   */
  lazy val ScalaCompilerVersion = new AttributeName("Scala-Compiler-Version")
}
...
private[scala] trait PropertiesTrait {
   ...
   *  cannot be read.
   */
  lazy val releaseVersion = scalaPropOrNone("version.number") flatMap { s =>
   ...
   */
  lazy val developmentVersion = scalaPropOrNone("version.number") flatMap { s =>
    val segments = s split '.'
   ...
   */
  lazy val versionString         = "version " + scalaPropOrElse("version.number", "(unknown)")
  lazy val copyrightString       = scalaPropOrElse("copyright.string", "(c) 2002-2011 LAMP/EPFL")
