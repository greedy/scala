...
object Predef extends LowPriorityImplicits {
  ...
  def Map         = immutable.Map
  def Set         = immutable.Set
  ...
  def ClassManifest     = scala.reflect.ClassManifest
  def Manifest          = scala.reflect.Manifest
